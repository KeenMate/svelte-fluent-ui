<script lang="ts">
	import {Dialog, Select, Option, Switch, Button, Divider, TextField, Stack} from "$lib/index.js"
	import {settings, accentColors, type ThemeMode} from "$lib/stores/settings.js"
	import type {SlotType} from "$lib/types/index.js"
