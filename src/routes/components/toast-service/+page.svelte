<script lang="ts">
	import {QuickGrid, Stack, Grid, GridItem, Card, Button} from "$lib/index.js"
	import {toast} from "$lib/stores/toast.js"

	let lastToastId = ""

	function showSuccess() {
		console.log("[Demo Page] showSuccess() called")
		lastToastId = toast.success("Operation completed successfully!")
		console.log("[Demo Page] Toast ID returned:", lastToastId)
	}
...
import { ToastContainer } from '$lib/index.js';
...
// Later: toast.dismiss(id);`}</code></pre>
	...
	<Card>
		...
		<pre><code>{`import { toast } from '$lib/stores/toast.js';
