<script lang="ts">
	import {Dialog, Select, Option, Switch, Button, Divider, TextField, Stack} from "svelte-fluentui"
	import {settings, accentColors, type ThemeMode} from "svelte-fluentui"
