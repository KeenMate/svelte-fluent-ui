...
<Stack orientation="vertical" gap="1rem">
	...
	<References links={[
		{label: "FluentUI Web Component", href: "https://storybooks.fluentui.dev/web-components/?path=/docs/components-listbox--docs"},
		{label: "FluentUI Blazor", href: "https://www.fluentui-blazor.net/Listbox"}
	]} />
